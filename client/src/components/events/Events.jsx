...
const Events = ({ _userId }) => {
    ...
    //& fetch saved events on load + when recommended events update
    useEffect(() => {
    ...
    //& handle save event by persisting via API endpoint
    ...
    //& conditionally show JamBase attribution if any external event has data_source "jambase"
    const jambaseAttributionVisible = events.some(event => event.data_source === 'jambase');
    ...
    return (
        ...
        <div className="p-4 lg:p-8 text-white relative z-10 max-w-7xl mx-auto mt-20">
            ...
            {/* Conditional JamBase Attribution */}
            {jambaseAttributionVisible && (
            <div className="text-center mt-4 text-xs text-gray-400">
                ...
                className="underline"
                >
                Live Music Data provided by JamBase
                </a>
            </div>
            )}
